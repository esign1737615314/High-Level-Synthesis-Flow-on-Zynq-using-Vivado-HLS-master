...
public:
    ...
    static bool UnCommentSection(string SectionName, string FileName);
		static bool CopyFile(const string &sSrcFileName, const string & sDstFileName);
		//新增函数
		static bool GetValue(string KeyName, string SectionName, string FileName, bool& value);
		static bool GetValue(string KeyName, string SectionName, string FileName, int& value);
		static bool GetValue(string KeyName, string SectionName, string FileName, string& value);
		static bool GetValue(string KeyName, string SectionName, string FileName, long& value);
		
		static bool SetValue(string KeyName, string sValue, string SectionName, string FileName);
		static bool SetValue(string KeyName, int iValue, string SectionName, string FileName);
		static bool SetValue(string KeyName, long lValue, string SectionName, string FileName);
		static bool SetValue(string KeyName, bool bValue, string SectionName, string FileName);
